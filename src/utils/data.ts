import { Building2, Projector, SendToBack, ThumbsUp, Video, Youtube } from "lucide-react";
...
export const servicesWithLongDescription = [
  {
    ...
    description: "Producción de comerciales, contenidos sociales e informativos para televisión o eventos, redes, pantallas gigantes o cualquier otro medio.",
  ...
  },
  {
    ...
    description: "Reels, stories y videos optimizados para cada plataforma, diseñados para captar la atención y reforzar el branding.",
  ...
  },
  {
    ...
    description: "Contenido, entrevistas, eventos, vlogs, demostraciones y videos educativos.",
  ...
  },
  {
    ...
    description: "Animación promocional o storytelling visual, ideales para aumentar la retención de la audiencia.",
  ...
  },
  {
    ...
    description: "Videos corporativos, capacitaciones e inducción de personal con un enfoque profesional.",
  ...
  },
  {
    ...
    description: "Conversión de videos a formatos listos para proyectarse en salas de Cinépolis y Cinemex.",
